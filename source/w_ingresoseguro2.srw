HA$PBExportHeader$w_ingresoseguro2.srw
forward
global type w_ingresoseguro2 from w_response
end type
type st_ip from st_uo_transparent within w_ingresoseguro2
end type
type st_hostname from st_uo_transparent within w_ingresoseguro2
end type
type cb_cancel from u_cb within w_ingresoseguro2
end type
type sle_password from u_sle within w_ingresoseguro2
end type
type sle_userid from u_sle within w_ingresoseguro2
end type
type cb_ok from u_cb within w_ingresoseguro2
end type
end forward
...
global w_ingresoseguro2 w_ingresoseguro2
