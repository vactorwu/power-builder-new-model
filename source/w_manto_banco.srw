HA$PBExportHeader$w_manto_banco.srw
forward
global type w_manto_banco from w_manto
end type
end forward
...
integer width = 2711
integer height = 2232
string title = "Cat$$HEX1$$e100$$ENDHEX$$logo de Bancos"
string is_tabla = "BANCO"
string is_campocod = "CodBanco"
string is_campoid = "IdBanco"
integer ii_largocod = 3
string is_campofinal = "estado"
end type
global w_manto_banco w_manto_banco

on w_manto_banco.create
int iCurrent
call super::create
end on

on w_manto_banco.destroy
call super::destroy
if IsValid(MenuID) then destroy(MenuID)
end on

type gb_comandos from w_manto`gb_comandos within w_manto_banco
integer x = 311
integer y = 1512
integer width = 2048
integer height = 528
...
type tab_todo from w_manto`tab_todo within w_manto_banco
integer x = 0
integer width = 2674
integer height = 2052
end type
...
integer width = 2638
integer height = 876
string dataobject = "d_banco_manto"
end type
...
integer width = 2560
integer height = 1068
string dataobject = "d_banco_lista"
end type

event dw_lista::ue_refresh;call super::ue_refresh;	idw_lista.retrieve( )
end event

event dw_lista::ue_getid;call super::ue_getid;	id_Codigo=this.object.idBanco [this.getrow()]	
end event
...
type shl_cerrar from w_manto`shl_cerrar within w_manto_banco
integer x = 1957
integer y = 1728
end type

type shl_grabar from w_manto`shl_grabar within w_manto_banco
integer x = 1335
integer y = 1728
end type

type shl_eliminar from w_manto`shl_eliminar within w_manto_banco
integer x = 1024
integer y = 1728
end type

type shl_modificar from w_manto`shl_modificar within w_manto_banco
integer x = 713
integer y = 1728
end type

type shl_nuevo from w_manto`shl_nuevo within w_manto_banco
integer x = 402
integer y = 1728
end type

type uo_nav from w_manto`uo_nav within w_manto_banco
integer x = 603
integer y = 1868
end type

type pb_cancelar from w_manto`pb_cancelar within w_manto_banco
integer x = 1714
integer y = 1576
end type

type pb_grabar from w_manto`pb_grabar within w_manto_banco
integer x = 1403
integer y = 1576
end type

type pb_eliminar from w_manto`pb_eliminar within w_manto_banco
integer x = 1093
integer y = 1576
end type

type pb_nuevo from w_manto`pb_nuevo within w_manto_banco
integer x = 471
integer y = 1576
end type

type pb_cerrar from w_manto`pb_cerrar within w_manto_banco
integer x = 2025
integer y = 1576
end type

type shl_cancelar from w_manto`shl_cancelar within w_manto_banco
integer x = 1646
integer y = 1728
end type

type pb_modificar from w_manto`pb_modificar within w_manto_banco
integer x = 782
integer y = 1576
end type
