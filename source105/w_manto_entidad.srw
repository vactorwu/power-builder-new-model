HA$PBExportHeader$w_manto_entidad.srw
forward
global type w_manto_entidad from w_manto
end type
end forward
...
global w_manto_entidad w_manto_entidad

type variables
DataWindowChild idwc_DocumentoIdentidad , idwc_CreditoCiclo
end variables
...
on w_manto_entidad.create
int iCurrent
call super::create
end on

on w_manto_entidad.destroy
call super::destroy
if IsValid(MenuID) then destroy(MenuID)
end on

type gb_comandos from w_manto`gb_comandos within w_manto_entidad
integer x = 55
integer y = 2192
integer width = 3470
end type

type tab_todo from w_manto`tab_todo within w_manto_entidad
integer x = 0
integer width = 3607
integer height = 2564
end type
...
event dw_lista::ue_getid;call super::ue_getid;	id_Codigo=this.object.IdEntidad [this.getrow()]	
end event
...
integer width = 3570
integer height = 2084
string dataobject = "d_entidad_manto"
...
of_setcampocalendario("creditofechainicio")
...
IF idw_activa.GetChild('CreditoCiclo', idwc_CreditoCiclo) = -1 THEN MessageBox(  "Error", "CreditoCiclo Not a DataWindowChild")
idwc_CreditoCiclo.SetTransObject(SQLCA)
idwc_CreditoCiclo.Retrieve('CreditoCiclo')
end event
...
type shl_cerrar from w_manto`shl_cerrar within w_manto_entidad
integer x = 3099
integer y = 2404
end type

type shl_grabar from w_manto`shl_grabar within w_manto_entidad
integer x = 1015
integer y = 2404
end type

type shl_eliminar from w_manto`shl_eliminar within w_manto_entidad
integer x = 704
integer y = 2404
end type

type shl_modificar from w_manto`shl_modificar within w_manto_entidad
integer x = 393
integer y = 2404
end type

type shl_nuevo from w_manto`shl_nuevo within w_manto_entidad
integer x = 82
integer y = 2404
end type

type uo_nav from w_manto`uo_nav within w_manto_entidad
integer x = 1632
integer y = 2300
end type

type pb_cancelar from w_manto`pb_cancelar within w_manto_entidad
integer x = 1394
integer y = 2252
end type

type pb_grabar from w_manto`pb_grabar within w_manto_entidad
integer x = 1083
integer y = 2252
end type

type pb_eliminar from w_manto`pb_eliminar within w_manto_entidad
integer x = 773
integer y = 2252
end type

type pb_nuevo from w_manto`pb_nuevo within w_manto_entidad
integer x = 151
integer y = 2252
end type

type pb_cerrar from w_manto`pb_cerrar within w_manto_entidad
integer x = 3168
integer y = 2252
end type

type shl_cancelar from w_manto`shl_cancelar within w_manto_entidad
integer x = 1326
integer y = 2404
end type

type pb_modificar from w_manto`pb_modificar within w_manto_entidad
integer x = 462
integer y = 2252
end type

type pb_ventana_y_libreria from w_manto`pb_ventana_y_libreria within w_manto_entidad
end type
