HA$PBExportHeader$w_manto_unidad.srw
forward
global type w_manto_unidad from w_manto
end type
end forward
...
integer width = 2839
integer height = 2328
string title = "Cat$$HEX1$$e100$$ENDHEX$$logo de Unidades"
string is_tabla = "UNIDAD"
string is_campocod = "CodUnidad"
string is_campoid = "IdUnidad"
integer ii_largocod = 3
string is_campofinal = "estado"
end type
global w_manto_unidad w_manto_unidad

on w_manto_unidad.create
int iCurrent
call super::create
end on

on w_manto_unidad.destroy
call super::destroy
if IsValid(MenuID) then destroy(MenuID)
end on

type gb_comandos from w_manto`gb_comandos within w_manto_unidad
integer x = 311
integer y = 1512
integer width = 2048
integer height = 528
...
type tab_todo from w_manto`tab_todo within w_manto_unidad
integer x = 0
integer width = 2674
integer height = 2052
end type
...
event dw_lista::ue_refresh;call super::ue_refresh;
	idw_lista.retrieve( )
end event

event dw_lista::ue_getid;call super::ue_getid;
	id_Codigo=this.object.IdUnidad [this.getrow()]	
end event
...
integer width = 2638
integer height = 1076
string dataobject = "d_unidad_manto"
end type
...
event dw_manto::ue_refresh;call super::ue_refresh;
...
type shl_cerrar from w_manto`shl_cerrar within w_manto_unidad
integer x = 1957
integer y = 1728
end type

type shl_grabar from w_manto`shl_grabar within w_manto_unidad
integer x = 1335
integer y = 1728
end type

type shl_eliminar from w_manto`shl_eliminar within w_manto_unidad
integer x = 1024
integer y = 1728
end type

type shl_modificar from w_manto`shl_modificar within w_manto_unidad
integer x = 713
integer y = 1728
end type

type shl_nuevo from w_manto`shl_nuevo within w_manto_unidad
integer x = 402
integer y = 1728
end type

type uo_nav from w_manto`uo_nav within w_manto_unidad
integer x = 603
integer y = 1868
end type

type pb_cancelar from w_manto`pb_cancelar within w_manto_unidad
integer x = 1714
integer y = 1576
end type

type pb_grabar from w_manto`pb_grabar within w_manto_unidad
integer x = 1403
integer y = 1576
end type

type pb_eliminar from w_manto`pb_eliminar within w_manto_unidad
integer x = 1093
integer y = 1576
end type

type pb_nuevo from w_manto`pb_nuevo within w_manto_unidad
integer x = 471
integer y = 1576
end type

type pb_cerrar from w_manto`pb_cerrar within w_manto_unidad
integer x = 2025
integer y = 1576
end type

type shl_cancelar from w_manto`shl_cancelar within w_manto_unidad
integer x = 1646
integer y = 1728
end type

type pb_modificar from w_manto`pb_modificar within w_manto_unidad
integer x = 782
integer y = 1576
end type

type pb_ventana_y_libreria from w_manto`pb_ventana_y_libreria within w_manto_unidad
end type
