HA$PBExportHeader$w_manto_listaprecio.srw
forward
global type w_manto_listaprecio from w_manto
end type
end forward
...
integer width = 2706
integer height = 1988
string title = "Cat$$HEX1$$e100$$ENDHEX$$logo de Lista de Precios"
string is_tabla = "LISTAPRECIO"
string is_campocod = "CodListaPrecio"
string is_campoid = "IdListaPrecio"
integer ii_largocod = 2
string is_campofinal = "estado"
end type
global w_manto_listaprecio w_manto_listaprecio
...
on w_manto_listaprecio.create
int iCurrent
call super::create
end on

on w_manto_listaprecio.destroy
call super::destroy
if IsValid(MenuID) then destroy(MenuID)
end on

type gb_comandos from w_manto`gb_comandos within w_manto_listaprecio
integer x = 311
integer y = 1260
integer width = 2048
integer height = 528
...
type tab_todo from w_manto`tab_todo within w_manto_listaprecio
integer x = 0
integer width = 2674
integer height = 1808
end type
...
integer width = 2638
integer height = 1680
string text = "Datos de Lista de Precio"
end type
...
integer width = 2674
integer height = 1080
string dataobject = "d_listaprecio_manto"
end type
...
choose case le_status	
	case new!,newmodified!
			If il_Fila > 0 then				
				messagebox("Advertecia " + Gn_Config.Is_Work.Aplicacion  ,"Lista de Precios ya existe......!!!"+char(13)+"Fila : "+String(il_Fila)+"  C$$HEX1$$f300$$ENDHEX$$digo : "+ls_Codigo,Exclamation!)
...
integer width = 2606
integer height = 816
string dataobject = "d_listaprecio_lista"
end type

event dw_lista::ue_refresh;call super::ue_refresh;idw_lista.retrieve(gn_config.is_work.idempresa )
end event

event dw_lista::ue_getid;call super::ue_getid;id_Codigo=This.object.idListaPrecio [This.getrow()]	
end event
...
type shl_cerrar from w_manto`shl_cerrar within w_manto_listaprecio
integer x = 1957
integer y = 1476
end type

type shl_grabar from w_manto`shl_grabar within w_manto_listaprecio
integer x = 1335
integer y = 1476
end type

type shl_eliminar from w_manto`shl_eliminar within w_manto_listaprecio
integer x = 1024
integer y = 1476
end type

type shl_modificar from w_manto`shl_modificar within w_manto_listaprecio
integer x = 713
integer y = 1476
end type

type shl_nuevo from w_manto`shl_nuevo within w_manto_listaprecio
integer x = 402
integer y = 1476
end type

type uo_nav from w_manto`uo_nav within w_manto_listaprecio
integer x = 603
integer y = 1616
end type

type pb_cancelar from w_manto`pb_cancelar within w_manto_listaprecio
integer x = 1714
integer y = 1324
end type

type pb_grabar from w_manto`pb_grabar within w_manto_listaprecio
integer x = 1403
integer y = 1324
end type

type pb_eliminar from w_manto`pb_eliminar within w_manto_listaprecio
integer x = 1093
integer y = 1324
end type

type pb_nuevo from w_manto`pb_nuevo within w_manto_listaprecio
integer x = 471
integer y = 1324
end type

type pb_cerrar from w_manto`pb_cerrar within w_manto_listaprecio
integer x = 2025
integer y = 1324
end type

type shl_cancelar from w_manto`shl_cancelar within w_manto_listaprecio
integer x = 1646
integer y = 1476
end type

type pb_modificar from w_manto`pb_modificar within w_manto_listaprecio
integer x = 782
integer y = 1324
end type
