...
event dw_lista::ue_refresh;call super::ue_refresh;If (id_idSub = 0) Then SetNull(id_idSub)
idw_lista.retrieve(gn_config.is_work.idempresa, id_idSub )
end event

event dw_lista::ue_getid;call super::ue_getid;id_Codigo=This.object.idLinea [This.getrow()]	
end event

event dw_lista::doubleclicked;call super::doubleclicked;//If This.rowcount( ) > 0 Then 
//	ii_nivel ++
//	id_idlinea[ii_nivel] =  This.object.idlinea[this.getrow()]
//	is_codlinea[ii_nivel] =  This.object.codlinea[this.getrow()]
//	
//	id_idlinea_ant[ii_nivel] =  This.object.idsublinea[this.getrow()]
//	
